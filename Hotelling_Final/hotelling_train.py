...
if __name__ == "__main__":
    # --- CRÉATION D'UNE STRATÉGIE COMMUNE ÉQUITABLE ---
    # On utilise la même instance pour être sûr que les paramètres sont identiques
    fair_loyalty = HighBrandLoyalty(base_rate=0.5, tenure_bonus=0.05) 
    
    print("\n" + "=" * 70)
    print("SCENARIO 1: LOW MOVEMENT COST (Fluid Market)")
    print("=" * 70)

    # On passe explicitement la stratégie aux DEUX agents
    env1, ben1, jerry1 = train_agents(
        ...
        visualize=True,
        ben_loyalty_strategy=fair_loyalty,   # <--- FORCE L'ÉGALITÉ
        jerry_loyalty_strategy=fair_loyalty  # <--- FORCE L'ÉGALITÉ
    )
